...
public class FunctionBuffer implements Function
{
	...
	{
		if( arity != 3 || a0 < 0 || size <= a0 || 
				a1 < 0 || size <= a1 || a2 < 0 || size <= a2 )
			throw new IllegalArgumentException();
		
		return (a0 * size + a1) * size + a2;
	}

	public void setByIndex(int index, int b) { buffer[index] = b; }
	public int valueByIndex(int index) { return buffer[index]; }

	public void set(int b) { buffer[index()] = b; }
	public void set(int a0, int b) { buffer[index(a0)] = b; }
	public void set(int a0, int a1, int b) { buffer[index(a0,a1)] = b; }
	public void set(int a0, int a1, int a2, int b) { buffer[index(a0,a1,a2)] = b; }
	public void set(int args[], int b) { buffer[index(args)] = b; }

	public int value() { return buffer[index()]; }
	public int value(int a0) { return buffer[index(a0)]; }
	public int value(int a0, int a1) { return buffer[index(a0,a1)]; }
	public int value(int a0, int a1, int a2) { return buffer[index(a0,a1,a2)]; }
	public int value(int args[]) { return buffer[index(args)]; }
}
