...
public final class IntegerAdd extends BinaryOp<Integer, int[]> {
	private IntegerAdd() {
	...
	public void apply(int[] src1, int src1Pos, int[] src2, int src2Pos,
		...
		for (int i = 0; i < count; i++)
			dst[dstPos + i] = src1[src1Pos + i] + src2[src2Pos + i];
	}
	...
	public static final IntegerAdd INSTANCE = new IntegerAdd();
}
