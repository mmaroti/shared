...
public class ApplicationWindow extends JFrame {
	protected Preferences prefs = Preferences.userRoot().node(
	...
	private void initialize() {
		...
		if (java.beans.Beans.isDesignTime())
			...
			setBounds(100, 100, prefs.getInt(PREF_WINDOW_WIDTH, 600),
					prefs.getInt(PREF_WINDOW_HEIGHT, 400));
		...
		// do this last, so we do not overwrite the preferences during
		// construction
		...
		addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent arg0) {
				prefs.putInt(PREF_WINDOW_WIDTH,
						ApplicationWindow.this.getWidth());
				prefs.putInt(PREF_WINDOW_HEIGHT,
						ApplicationWindow.this.getHeight());
			}
		});
	}
