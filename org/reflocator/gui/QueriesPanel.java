...
public class QueriesPanel extends JPanel {
	...
	public QueriesPanel() {
		...
		fieldsPanel.setBorder(new TitledBorder(null, "Query details",
		...
		gbl_fieldsPanel.columnWeights = new double[] { 0.0, 1.0,
				Double.MIN_VALUE };
		gbl_fieldsPanel.rowWeights = new double[] { 0.0, 0.0, 0.0,
				Double.MIN_VALUE };
